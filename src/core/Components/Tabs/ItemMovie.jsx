...
export default function ItemMovie({ hinhAnh, tenPhim, lstLichChieuTheoPhim }) {
  ...
  return (
    <div className="movie p-11 flex gap-11">
      ...
      <div className="info flex flex-1 basis-4/6 flex-col gap-2 flex-grow">
        <h3 className="movie-title text-3xl font-semibold text-[#9CA7CB] hover:text-white transition-all duration-700 cursor-pointer">
          {tenPhim}
        </h3>
